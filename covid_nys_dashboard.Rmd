...
On a daily basis the [NY Department of Health](https://coronavirus.health.ny.gov/county-county-breakdown-positive-cases) was updating the cummulative count of cases testing positive for COVID-19 at the county level. During the crisis the NYS COVID website WAS NOT publicly reporting:

1. Cases at the borough level for New York City. 
2. Daily count of number of COVID tests performed.

Given the cummulative count, it was hard to know the change in number cases from day to day, reason why I started scraping the website on a daily basis. 
